package dev.gllody.meteorcapes.hud;

import dev.gllody.meteorcapes.MeteorCapes;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(MeteorCapes.HUD_GROUP, "example", "HUD element example.", HudExample::new);
